...
void CheckBudgetsAndTransactions()
{
                                         ...
                                         const std::string_view message)
    {
        ...
        Check(bounded->Snapshot().free_slots == 1U && bounded->Snapshot().reserved_slots == 0U,
...
void CheckForeignMoveAndRetirement()
{
    ...
    CheckError(source.Reserve(fixture.View()), RenderMeshErrorCode::InvalidConfiguration,
