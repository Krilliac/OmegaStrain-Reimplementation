...
//
// Format .pss - tracked aggregate occurrences: recursive-in-HOG = 54, top-level-HOG = 54.
// Tracked STRUCTURAL evidence for this format: NONE. tools/fingerprint_assets.py has no handler for
// .pss, and no analysis/formats/*.md documents its layout, so no field, offset, count, header,
...
//   1. Run tools/measure_member_structural_fingerprint.py (or add a fingerprint_pss handler to
...
//   3. Move this header to native/include/omega/retail/pss_container_descriptor.h, add
//      native/src/retail/pss_container_descriptor.cpp implementing InspectPssContainer as a
//      bounded, fail-closed, allocation-checked reader honoring DecodeLimits.
//   4. Register both in CMakeLists.txt and add native/tests/pss_container_descriptor_tests.cpp
...
{
// Passive structural descriptor placeholder for the .pss member family. Opaque until tracked
// evidence proves internal structure; no semantics are assigned to any payload byte.
struct PssContainerDescriptor
{
...
[[nodiscard]] asset::DecodeResult<PssContainerDescriptor> InspectPssContainer(
