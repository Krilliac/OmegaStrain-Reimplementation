...
//
// Format .gun - tracked aggregate occurrences: recursive-in-HOG = 624, top-level-HOG = 0.
// Tracked STRUCTURAL evidence for this format: NONE. tools/fingerprint_assets.py has no handler for
// .gun, and no analysis/formats/*.md documents its layout, so no field, offset, count, header,
...
//   1. Run tools/measure_member_structural_fingerprint.py (or add a fingerprint_gun handler to
...
//   3. Move this header to native/include/omega/retail/gun_container_descriptor.h, add
//      native/src/retail/gun_container_descriptor.cpp implementing InspectGunContainer as a
//      bounded, fail-closed, allocation-checked reader honoring DecodeLimits.
//   4. Register both in CMakeLists.txt and add native/tests/gun_container_descriptor_tests.cpp
...
{
// Passive structural descriptor placeholder for the .gun member family. Opaque until tracked
// evidence proves internal structure; no semantics are assigned to any payload byte.
struct GunContainerDescriptor
{
...
[[nodiscard]] asset::DecodeResult<GunContainerDescriptor> InspectGunContainer(
