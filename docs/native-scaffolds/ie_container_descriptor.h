...
//
// Format .ie - tracked aggregate occurrences: recursive-in-HOG = 79, top-level-HOG = 23.
// Tracked STRUCTURAL evidence for this format: NONE. tools/fingerprint_assets.py has no handler for
// .ie, and no analysis/formats/*.md documents its layout, so no field, offset, count, header,
...
//   1. Run tools/measure_member_structural_fingerprint.py (or add a fingerprint_ie handler to
...
//   3. Move this header to native/include/omega/retail/ie_container_descriptor.h, add
//      native/src/retail/ie_container_descriptor.cpp implementing InspectIeContainer as a
//      bounded, fail-closed, allocation-checked reader honoring DecodeLimits.
//   4. Register both in CMakeLists.txt and add native/tests/ie_container_descriptor_tests.cpp
...
{
// Passive structural descriptor placeholder for the .ie member family. Opaque until tracked
// evidence proves internal structure; no semantics are assigned to any payload byte.
struct IeContainerDescriptor
{
...
[[nodiscard]] asset::DecodeResult<IeContainerDescriptor> InspectIeContainer(
