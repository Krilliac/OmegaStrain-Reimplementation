# .elf — whole-disc disposition dossier

## 1. Identity

The suffix `.elf` is observed only in the tracked whole-disc inventory. It has no occurrence
...
| Whole-disc inventory | 4 | `analysis/manifests/disc-summary.json` |
...
The only family-wide public aggregate established here is an occurrence count of 4 at
...
- **H1 — one structural family.** Files sharing `.elf` may implement one grammar, or the
