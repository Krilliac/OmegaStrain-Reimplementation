# .bnk — occurrence-only archive-member dossier

## 1. Identity

The suffix `.bnk` is observed as a HOG member but has no dedicated structural aggregate,
...
| Top-level HOG inventory | 77 | `analysis/formats/hog-validation.json` |
| Whole-disc inventory | 0 | `analysis/manifests/disc-summary.json` |

## 3. Confirmed facts

- The tracked inventories establish 77 recursive and 77 direct top-level HOG
...
- `analysis/formats/DECODER-COVERAGE.md` classifies `.bnk` as
