# .ini — whole-disc disposition dossier

## 1. Identity

The suffix `.ini` is observed only in the tracked whole-disc inventory. It has no occurrence
...
| Whole-disc inventory | 1 | `analysis/manifests/disc-summary.json` |
...
The only family-wide public aggregate established here is an occurrence count of 1 at
...
- **H1 — one structural family.** Files sharing `.ini` may implement one grammar, or the
