# .sys — whole-disc disposition dossier

## 1. Identity

The suffix `.sys` is observed only in the tracked whole-disc inventory. It has no occurrence
...
- **H1 — one structural family.** Files sharing `.sys` may implement one grammar, or the
