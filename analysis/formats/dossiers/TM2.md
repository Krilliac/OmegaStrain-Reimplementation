# .tm2 — hard-rule Unknown dossier

## 1. Identity

The suffix `.tm2` appears only in the whole-disc inventory: 16 occurrences and no
...
| Whole-disc inventory | 16 | `analysis/manifests/disc-summary.json` |

## 3. Confirmed facts

- The three tracked occurrence inventories establish the counts above.
- The authoritative `analysis/formats/DECODER-COVERAGE.md` matrix classifies `.tm2` as
...
- **H1 — shared grammar.** The 16 files may share a structure, or the suffix may group
