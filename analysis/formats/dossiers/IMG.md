# .img — whole-disc disposition dossier

## 1. Identity

The suffix `.img` is observed only in the tracked whole-disc inventory. It has no occurrence
...
The only family-wide public aggregate established here is an occurrence count of 3 at
...
- **H1 — one structural family.** Files sharing `.img` may implement one grammar, or the
