# .rgb — whole-disc disposition dossier

## 1. Identity

The suffix `.rgb` is observed only in the tracked whole-disc inventory. It has no occurrence
...
- **H1 — one structural family.** Files sharing `.rgb` may implement one grammar, or the
