# .64 — whole-disc disposition dossier

## 1. Identity

The suffix `.64` is observed only in the tracked whole-disc inventory. It has no occurrence
...
- The tracked boot metadata identifies the observed `.64` file as the title boot ELF. This is a fact about that file, not a decoder classification for the suffix family. Source: `analysis/elf/SCUS_97264.metadata.json` and ledger entries E-0002/E-0004.
...
- **H1 — one structural family.** Files sharing `.64` may implement one grammar, or the
