# .irx — whole-disc disposition dossier

## 1. Identity

The suffix `.irx` is observed only in the tracked whole-disc inventory. It has no occurrence
...
| Whole-disc inventory | 46 | `analysis/manifests/disc-summary.json` |
...
The only family-wide public aggregate established here is an occurrence count of 46 at
...
- **H1 — one structural family.** Files sharing `.irx` may implement one grammar, or the
