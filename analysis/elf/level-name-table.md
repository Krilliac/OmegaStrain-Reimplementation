...
All eighteen names also already appear in this repository's tracked
`analysis/manifests/disc-files.jsonl`, so recording them here introduces no
reference content that the public tree did not already carry.
